...
# region East
    ...
    public HashSet<Point> GetNeighbors()
    {
            ...
            if (this.N != null && this.N.color == Color.nul)
            {
                points.Add(this.N);
            }
            if (this.NE != null && this.NE.color == Color.nul)
            {
                points.Add(this.NE);
            }
            if (this.NW != null && this.NW.color == Color.nul)
            {
                points.Add(this.NW);
            }
            if (this.S != null && this.S.color == Color.nul)
            {
                points.Add(this.S);
            }
            if (this.SE != null && this.SE.color == Color.nul)
            {
                points.Add(this.SE);
            }
            if (this.SW != null && this.SW.color == Color.nul)
            {
                points.Add(this.SW);
            }
            if (this.E != null && this.E.color == Color.nul)
            {
                points.Add(this.E);
            }
            if (this.W != null && this.W.color == Color.nul)
            {
                points.Add(this.W);
            }
